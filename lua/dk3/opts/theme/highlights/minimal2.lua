...
function M.setup()
    ...
    set(0, "FoldColumn", {fg = pal.normals.gray}) -- column where folds are displayed
    set(0, "Folded", {fg = pal.normals.gray, bg = none,}) -- line used for closed folds
    ...
    set(0, "Function", {fg = pal.normals.cyan, bold = config.bold}) -- function name (also: methods for classes)
    ...
    set(0, "Label", {fg = pal.normals.fg1}) -- case, default, etc.
