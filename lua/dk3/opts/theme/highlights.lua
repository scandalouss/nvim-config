...
function theme.setup()
    ...
    theme.highlights={
        ...
        CursorLineNr={fg=pal.normals.blue,bg=none},
        DiffAdd={fg=pal.normals.green},
        DiffChange={fg=pal.normals.yellow},
        DiffDelete={fg=pal.normals.red},
        DiffText={fg=pal.normals.cyan},
        ...
        ColorColumn={fg=pal.fg1, bg=pal.bg2},
        ...
        --marks.nvim
        MarkSignNumHL={fg=pal.normals.blue,bg=none},
        MarkSignNumHL={},
